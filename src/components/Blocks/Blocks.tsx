  ...
  return (
    <div className="-mx-4 sm:-mx-20 xl:-mx-32">
      <div className="background-2 flex h-40 w-full flex-col items-center justify-center sm:h-70">
        ...
        <button className="rounded-xl bg-white px-12 py-3 font-medium text-neutral-700 shadow-xl hover:bg-neutral-100 hover:text-blue-600 sm:px-20 sm:py-4 sm:text-lg">
          Get Started
        </button>
      </div>
    </div>

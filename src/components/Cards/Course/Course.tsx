...
const Course = (props: {
  ...
  return (
    <>
      <div className="h-125 w-88 scale-[0.9] rounded-2xl border border-neutral-200 bg-white shadow-xl sm:scale-[0.9] lg:scale-[0.85] xl:scale-[1]">
        ...
        <div className="flex h-3/5 flex-col justify-between px-8 py-8">
          ...
          <button className="h-11 w-full rounded-2xl bg-blue-500 font-medium text-white shadow-lg hover:bg-blue-600">
            Buy
          </button>
        </div>
      </div>

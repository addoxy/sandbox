...
const FeaturesCard = () => {
  return (
    <div className="mx-auto grid max-w-md grid-cols-none grid-rows-3 rounded-2xl border border-neutral-200 lg:h-fit lg:w-full lg:max-w-none lg:grid-cols-3 lg:grid-rows-none">
      ...
      <div className="flex h-full flex-col items-center justify-center border-neutral-200 py-2 ">
        <div className="flex p-8">
          <IconContainer icon="fa-solid:chalkboard-teacher" className="mr-6" />
          <div className="flex flex-col">
            <span className="mb-2 text-lg font-semibold text-neutral-700">
              Top Teachers
            </span>
